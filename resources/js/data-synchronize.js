$(() => {
        ...
        httpClient
            ...
            .then(async ({ headers, data }) => {
                if (headers['content-disposition'] === undefined) {
                    ...
                    Dashopapp.showError(responseJson?.message || $form.data('error-message'))
                ...
                Dashopapp.showSuccess($form.data('success-message'))
            })
            .catch((error) => {
                console.log(error)
                Dashopapp.showError($form.data('error-message'))
            })
    }
    ...
    if ($form.length > 0) {
        ...
        const cleanup = () => {
            Dashopapp.hideButtonLoading($button)
        ...
        dropzone.on('sending', () => {
            ...
            Dashopapp.showButtonLoading($button)
        })
