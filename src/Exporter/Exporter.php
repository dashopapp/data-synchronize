...
namespace Dashopapp\DataSynchronize\Exporter;

use Dashopapp\Base\Facades\Assets;
use Dashopapp\Base\Facades\BaseHelper;
use Dashopapp\DataSynchronize\Concerns\Exporter\HasEmptyState;
use Dashopapp\DataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \Dashopapp\DataSynchronize\Exporter\ExportColumn[]
     */
    ...
    /**
     * @return \Dashopapp\DataSynchronize\Exporter\ExportCounter[]
     */
